            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="{{route('events.store')}}">
                        ...
                        <input type="datetime-local" class="form-control" name="start_date"  class="date" placeholder="Enter The start"><br /> <br />
                        <label for="">Enter Of End Date</label>
                        <input type="datetime-local"  class="form-control" name="end_date"  class="date" placeholder="Enter The end"><br /> <br />
