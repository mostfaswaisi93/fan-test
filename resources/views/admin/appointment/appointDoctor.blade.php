                    ...
                    <div class="chat-sidebar-list">
                        <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
                            ...
                            <ul class="media-list list-items">
                                <li class="media"><img class="media-object" src="{{asset("plugin/img/doc/doc3.svg")}}" width="35" height="35" alt="...">
                                ...
                                <li class="media">
                                    ...
                                    </div> <img class="media-object" src="{{asset("plugin/img/doc/doc1.svg")}}" width="35" height="35" alt="...">
                                    <i class="busy dot"></i>
                                    <div class="media-body">
                                ...
                                <li class="media"><img class="media-object" src="{{asset("plugin/img/doc/doc5.svg")}}" width="35" height="35" alt="...">
                                    <i class="away dot"></i>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    </div> <img class="media-object" src="{{asset("plugin/img/doc/doc4.svg")}}" width="35" height="35" alt="...">
                                    <i class="online dot"></i>
                                    <div class="media-body">
                                ...
                                <li class="media"><img class="media-object" src="{{asset("plugin/img/doc/doc2.svg")}}" width="35" height="35" alt="...">
                                    <i class="busy dot"></i>
                                    <div class="media-body">
                                ...
                                <li class="media"><img class="media-object" src="{{asset("plugin/img/doc/doc7.svg")}}" width="35" height="35" alt="...">
                                    <i class="online dot"></i>
                                    <div class="media-body">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    </div> <img class="media-object" src="{{asset("plugin/img/doc/doc6.svg")}}" width="35" height="35" alt="...">
                                ...
                                <li class="media"><img class="media-object" src="{{asset("plugin/img/doc/doc8.svg")}}" width="35" height="35" alt="...">
                                    <i class="offline dot"></i>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    </div> <img class="media-object" src="{{asset("plugin/img/doc/doc9.svg")}}" width="35" height="35" alt="...">
                                    <i class="offline dot"></i>
                                    <div class="media-body">
                                ...
                                <li class="media"><img class="media-object" src="{{asset("plugin/img/doc/doc10.svg")}}" width="35" height="35" alt="...">
                                    <i class="offline dot"></i>
                                    <div class="media-body">
                    ...
                    <div class="chat-sidebar-item">
                        <div class="chat-sidebar-chat-user">
                            ...
                            <div class="chat-sidebar-chat-user-messages">
                                <div class="post out">
                                    <img class="avatar" alt="" src="{{asset("plugin/img/dp.svg")}}" />
                                    <div class="message">
                                ...
                                <div class="post in">
                                    <img class="avatar" alt="" src="{{asset("plugin/img/doc/doc5.svg")}}" />
                                    <div class="message">
