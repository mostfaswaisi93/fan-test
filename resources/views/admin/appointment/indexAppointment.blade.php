    ...
    <div class="row">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Appointment List
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="col">
                                                        <a class="btn btn-info" href="{{ url('appointment/create') }}">Add
                                                            Appointment<i class="fa fa-plus"></i></a>
                                                    </div>
<br>
                                        ...
                                        <div class="uper">
                                            ...
                                            <table class="table appointments">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Patients</td>
                                                    <td>Doctors</td>
                                                    <td>Start Date Of Appointment</td>
                                                    <td>End Date Of Appointment</td>
                                                    <td>Details</td>
                                                    <td>Action</td>
                                                </tr>
                                                </thead>
                                                ...
                                                @foreach($appointment as $appointments)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('appointment.edit',$appointments->id)}}"
                                                               class="btn btn-primary btn-xs fa fa-pencil">

                                                            </a>
                                                            <form
                                                                action="{{ route('appointment.destroy', $appointments->id)}}"
