    ...
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            ...
            <ol class="breadcrumb page-breadcrumb pull-right">
                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item">Home</a>&nbsp;<i
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <div class="btn-group">
                                                ...
                                                <div class="col">
                                                    <a class="btn btn-info" href="{{ url('doctor/create') }}">Add
                                                        Doctor<i class="fa fa-plus"></i></a>
                                                </div>
                                                <br>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img src="{{asset('storage/'.$doctors->photo)}}" alt=""
                                                            width="80" height="80">
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{ route('doctor.destroy', $doctors->id)}}"
