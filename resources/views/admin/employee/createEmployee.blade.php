            ...
            <select id="gender"  class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ old('gender') }}" required autocomplete="gender">
                ...
                <div class="form-group " style="width:350px;">
                    <label for="specialty">Specialty</label>
                        ...
                        <select id="specialty"  class="form-control @error('specialty') is-invalid @enderror" name="specialty" value="{{ old('specialty') }}" required autocomplete="specialty">
                            <option value="-1">Choose Specialty</option>
                ...
                <div class="form-group">
                    <label for="user_id">Doctors</label>
