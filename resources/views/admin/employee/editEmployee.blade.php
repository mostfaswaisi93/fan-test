    ...
    <div class="card-body">
        ...
        <form method="Post" action="{{ route('employee.update', $employee->id) }}">
            ...
            <div class="form-group" style="width:350px;">
                ...
                <input type="number" class="form-control" name="phone" value="{{$employee->phone}}" id="name" />
            </div>
            <div class="form-group" style="width:350px;">
                <label for="quantity">Aderss</label>
                <input type="text" class="form-control" name="aderss" value="{{$employee->aderss}}" id="name" />
            </div>
            <div class="form-group" style="width:350px;">
                <label for="quantity">Gender</label>
                <select id="gender" class="form-control" name="gender" value="{{$employee->gender}}" id="name">
            ...
            <div class="form-group" style="width:350px;">
                ...
                <input type="email" class="form-control" name="email" value="{{$employee->email}}" id="name" />
            </div>
            <div class="form-group" style="width:350px;">
                <label for="DOB">Date of Barth:</label>
                <input type="date" class="form-control" name="DOB" value="{{$employee->DOB}}" id="name" />
            </div>
