                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="col">
                                                        <a class="btn btn-info" href="{{ url('employee/create') }}">Add Employee<i class="fa fa-plus"></i></a>
                                                    </div>
<br>
                                                    ...
                                                    @foreach($employee as $employees)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <form
                                                                    action="{{ route('employee.destroy', $employees->id)}}"
