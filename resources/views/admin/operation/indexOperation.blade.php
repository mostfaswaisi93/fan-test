    ...
    <div class="row">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Operation List</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="master">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                                            ...
                                            <table class="table patient">
                                                ...
                                                @foreach($operation as $operations)
                                                    <tr>
                                                        <td>{{$operations->id}}</td>
                                                        <td name="patient_id">
                                                            {{$operations->patients->name}}
                                                        </td>

                                                        <td name="doctor_id">
                                                            {{$operations->doctors->name}}
                                                        </td>
                                                        <td>{{$operations->type_operate}}</td>
                                                        <td>{{$operations->date_of_operate}}</td>
                                                        <td>

                                                            <img src="{{asset('storage/'.$operations->photo_teeth)}}"
                                                                 alt="" width= "80" height="80" >
                                                        </td>

                                                        <td>

                                                            <a href="{{route('operation.edit',$operations->id)}}"
                                                               class="btn btn-primary btn-xs fa fa-pencil">

                                                            </a>
                                                            <form
                                                                action="{{ route('operation.destroy', $operations->id)}}"
