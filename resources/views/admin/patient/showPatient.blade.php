    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tr>
                <th>Actien</th>
                <td>
                    <a href="{{route('createPayment',$patient->id)}}" class="btn btn-primary btn-xs">Add Payment</a><a
                        href="{{route('pays.show',$patient->id)}}" class="btn btn-danger btn-xs">All Payment</a></td>
