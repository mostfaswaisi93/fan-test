    ...
    <div class="card-body">
        ...
        <form method="post" action="{{route('payment.update', $payment->id)}}">
            ...
            <div class="form-group" style="width:350px;">
                ...
                <input type="number" class="form-control" name="total_Amount" value="{{$payment->total_Amount}}"
                    disabled />
            </div>

            <div class="form-group" style="width:350px;">
                <label for="total_Amount">Remaining Amount</label>
                <input type="number" class="form-control" name="total_Amount" value="{{$payment->remaining_Amount}}"
                    disabled />
            </div>
