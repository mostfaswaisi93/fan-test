...
<div class="card uper">
    ...
    <div class="card-body">
        ...
        <form method="post" action="{{route('prescription.update', $prescription->id)}}">
            ...
            {{--                                            <option value="{{ $patintes->id }}"
            id="name">{{ $patintes->name }}</option>--}}
            {{--                                        @endforeach--}}
            {{--                                    </select>--}}
            {{--                                </div>--}}
            {{--                                <div class="form-group">--}}
            ...
            <div class="form-group" style="width:350px;">
                ...
                <input type="text" class="form-control" name="type_of_prescription"
                    value="{{$prescription->type_of_prescription}}" id="name" />
            </div>
            <div class="form-group" style="width:350px;">
                <label for="details">Details</label>
                <textarea class="form-control" name="details" id="name">{{$prescription->details}}</textarea>
            </div>

            <div class="form-group" style="width:350px;">
                <label for="date_of_prescription">Date Of Prescription</label>
                <input type="date" class="form-control" name="date_of_prescription"
                    value="{{$prescription->date_of_prescription}}" id="name" />
            </div>
