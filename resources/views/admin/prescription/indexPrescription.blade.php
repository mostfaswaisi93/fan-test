                                            ...
                                            <table class="table patient">
                                                ...
                                                @foreach($prescription as $prescriptions)
                                                    <tr>
                                                        ...
                                                        <td name="patient_id">
                                                            {{$prescriptions->patients->name}}
                                                        </td>

                                                        <td name="doctor_id">
                                                            {{$prescriptions->doctors->name}}
                                                        </td>
                                                        <td>{{$prescriptions->type_of_prescription}}</td>
                                                        <td>{{$prescriptions->details}}</td>
                                                        <td>{{$prescriptions->date_of_prescription}}</td>

                                                        <td>

                                                            <a href="{{route('prescription.edit',$prescriptions->id)}}"
                                                            ...
                                                            <form
                                                                action="{{ route('prescription.destroy', $prescriptions->id)}}"
