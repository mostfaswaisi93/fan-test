...
<head>
    ...
    <link href="{{asset("plugin/js/bootstrap-switch/css/bootstrap-switch.min.css")}}" rel="stylesheet" type="text/css"/>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown language-switch">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img
                                src="{{asset("plugin/img/flags/gb.png")}}" class="position-left" alt=""> English <span
                                class="fa fa-angle-down"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a class="deutsch"><img src="{{asset("plugin/img/flags/de.png")}}" alt=""> Deutsch</a>
                            </li>
                            <li>
                                <a class="ukrainian"><img src="{{asset("plugin/img/flags/ua.png")}}" alt=""> Українська</a>
                            </li>
                            <li>
                                <a class="english"><img src="{{asset("plugin/img/flags/gb.png")}}" alt=""> English</a>
                            </li>
                            <li>
                                <a class="espana"><img src="{{asset("plugin/img/flags/es.png")}}" alt=""> España</a>
                            </li>
                            <li>
                                <a class="russian"><img src="{{asset("plugin/img/flags/ru.png")}}" alt=""> Русский</a>
                            </li>
                        </ul>
                    </li>
                    <!-- end language menu -->
                                ...
                                <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                    ...
                                    <li>
                                        <a href="#">
                                            ...
                                            <span
                                                class="message"> Fwd: Important Notice Regarding Your Domain Name... </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <img alt="" class="{{asset("plugin/img-circle")}}" src="{{asset("plugin/img/dp.svg")}}"/>
                ...
                <div id="remove-scroll">
                    <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true"
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
{{--                                    <a href="{{route('events.index')}}" class="nav-link "> <span--}}
...
{{--                                    </a>--}}
        ...
        <script src="{{asset('plugin/js/bootstrap-switch/js/bootstrap-switch.min.js')}}"
